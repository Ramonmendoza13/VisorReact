  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.token) {
        ...
        setErrorMsg(data.mensaje || "Credenciales inválidas.");
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-[calc(100vh-180px)] flex items-center justify-center px-4 py-12">
      <div className="relative w-full max-w-md bg-gray-900/90 border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
        {/* Glow de fondo */}
        <div className="absolute -top-16 -right-16 w-40 h-40 bg-yellow-500/10 rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs sm:text-sm text-gray-400">
            Accede para guardar y gestionar tus series y películas favoritas
          </p>
        </div>
